...
```text
Retrieval:  Did we get the right evidence?
Generation: Did we use the evidence correctly?
End-to-end: Did the user get the right result?
Production: Can we keep doing it safely and reliably?
```
