---
title: The protocol map
description: Choose MCP, A2A, or A2UI from the boundary that needs a shared contract.
contentType: lesson
level: Beginner
minutes: 8
...
<LessonMeta level="Beginner" minutes={8} verified="15 Aug 2026" kind="Protocol guide" />
...
## Do not use a protocol where a function call is enough
